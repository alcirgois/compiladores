...
public final class ABlocoSemSubComando extends PSemSubComando
{
    private PBloco _bloco_;

    public ABlocoSemSubComando()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABlocoSemSubComando(
    ...
    {
        ((Analysis) sw).caseABlocoSemSubComando(this);
    }
