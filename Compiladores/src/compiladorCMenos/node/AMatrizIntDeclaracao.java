...
public final class AMatrizIntDeclaracao extends PDeclaracao
{
    private TId _nome_;
    private TNum _dimen_;

    public AMatrizIntDeclaracao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMatrizIntDeclaracao(
    ...
    {
        ((Analysis) sw).caseAMatrizIntDeclaracao(this);
    }
