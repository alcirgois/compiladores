...
public final class AMatrizStrDeclaracao extends PDeclaracao
{
    private TId _nome_;
    private TNum _dimen_;

    public AMatrizStrDeclaracao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMatrizStrDeclaracao(
    ...
    {
        ((Analysis) sw).caseAMatrizStrDeclaracao(this);
    }
