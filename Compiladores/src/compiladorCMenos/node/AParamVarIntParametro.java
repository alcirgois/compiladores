...
public final class AParamVarIntParametro extends PParametro
{
    private TId _nome_;

    public AParamVarIntParametro()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParamVarIntParametro(
    ...
    {
        ((Analysis) sw).caseAParamVarIntParametro(this);
    }
