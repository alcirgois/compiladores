...
public final class ASemSubComandoComandoIfNaoCurto extends PComandoIfNaoCurto
{
    private PSemSubComando _semSubComando_;

    public ASemSubComandoComandoIfNaoCurto()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASemSubComandoComandoIfNaoCurto(
    ...
    {
        ((Analysis) sw).caseASemSubComandoComandoIfNaoCurto(this);
    }
