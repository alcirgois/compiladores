...
public final class AParamMatrizIntParametro extends PParametro
{
    private TId _nome_;

    public AParamMatrizIntParametro()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParamMatrizIntParametro(
    ...
    {
        ((Analysis) sw).caseAParamMatrizIntParametro(this);
    }
